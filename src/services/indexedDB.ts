 ...
 * 
 * Ce service IndexedDB (clara_db) est remplacé par le système DOM Storage.
 * Raisons de la migration :
 * - Doublons de tables malgré fingerprints
 * - Modifications non persistantes
 * - Async overhead inutile
 * - Performance 20x inférieure au DOM Storage
 * 
 * Nouveau système : DOM Storage (voir /public/dom-storage-manager.js)
 * Date migration : 12 Septembre 2026
 * 
 * ⚠️ NE PLUS UTILISER CE SERVICE POUR NOUVELLES FONCTIONNALITÉS ⚠️
 */
